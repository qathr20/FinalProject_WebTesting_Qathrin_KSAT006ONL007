...
WebUI.setText(findTestObject('Object Repository/Register Account/input_Username_user_login-297'), 'nada')

WebUI.setText(findTestObject('Object Repository/Register Account/input_E-mail Address_user_email-297'), 'nada@gmail.com')

WebUI.setText(findTestObject('Object Repository/Register Account/input_Phone Number_phone_number-297'), '081234567890')

WebUI.setEncryptedText(findTestObject('Object Repository/Register Account/input_Password_user_password-297'), 'r6H/uPCyCbTGsbY/oCElaA==')
...
WebUI.setEncryptedText(findTestObject('Object Repository/Register Account/input_Confirm Password_confirm_user_password-297'), 
    'r6H/uPCyCbTGsbY/oCElaA==')

WebUI.setText(findTestObject('Object Repository/Register Account/input_Address_Relative_adress-297'), 'Indonesia')
